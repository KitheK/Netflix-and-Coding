...
# Create router with prefix /cart.  so they will be like /cart/add, /cart/{user_id}, etc.
...
#how it works:
# IN: Request body JSON → {"user_id": "...", "product_id": "...", "quantity": 2}
# MIDDLE: cart_service.add_to_cart() does the work (validate, load, update, save)
...
# GET /cart/{user_id} - get users cart with total price
...
def remove_from_cart(
    product_id: str,
    user_id: str = Query(..., description="User ID who owns the cart")
):
