...
from Order import Order,OrderItem,RefundRequest,Review
from enum import Enum, RefundStatus,UserRole
...
class Customer(User):
    ...
    def request_refund(self, order_id, reason):
        return RefundRequest(order_id, reason)
...
class Cart:
    ...
    def checkout(self):
        ...
        order = Order(customer_id=0, items=order_items)
        return order
