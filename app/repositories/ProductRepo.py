...
class ProductRepository:
    ...
    def load_products(self) -> list[Product]:
        ...
        with open(self.file_path, "r") as file:
            ...
            for item in data:
                # Create Product (only with product-level fields)
                product = Product(
                ...
                # If this item includes review info, parse and attach them
                if "user_id" in item:
                    ...
                    for i in range(len(user_ids)):
                        ...
                        review = Review(
                            ...
                            rating=0.0,  # dataset doesn’t have individual review ratings
